...
ColumnLayout {
    ...
    RowLayout {
        ...
        MaterialIcon {
            ...
            font.pointSize: Config.appearance.font.size.extraLarge * 2.5
        }
    ...
    Loader {
        ...
        Layout.topMargin: Config.appearance.spacing.smaller
        Layout.bottomMargin: Config.appearance.padding.large * 2
        Layout.fillWidth: true
