...
Popup {
    ...
    function show(x, y) {
        ...
        const menuWidth = 180;
        const menuHeight = menuColumn.implicitHeight + Config.appearance.padding.small * 2;
    ...
    width: 180
    height: menuColumn.implicitHeight + Config.appearance.padding.small * 2
    padding: 0
    modal: false
    ...
    contentItem: StyledRect {
        ...
        Column {
            ...
            StyledRect {
                width: parent.width - Config.appearance.padding.small * 2
                height: 5
